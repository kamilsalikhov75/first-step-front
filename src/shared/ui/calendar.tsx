  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-green-500 text-slate-50 hover:bg-green-500 hover:text-slate-50 focus:bg-green-500 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
